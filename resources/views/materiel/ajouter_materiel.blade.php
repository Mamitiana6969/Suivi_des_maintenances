...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('bootstrap/js/bootstrap.bundle.js') }}">
...
<div class="container">
  ...
  <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal"><i class="fas fa-save"></i> Enregistrer</button>
...
<h1 class=" text-primary text-center" style="font-size: 25px;">Confirmation !</h1>
      ...
      <div class="modal-body">
        Est-ce que vous pouvez enregistrer ce nouveau matériel ?
      </div>
